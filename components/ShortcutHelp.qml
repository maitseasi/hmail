...
Rectangle {
  ...
  readonly property var rows: [
    { keys: "j / k", action: "Move rows; scroll inside Feed or thread" },
    { keys: "Feed/thread J / K", action: "Next / previous message" },
    ...
    { keys: "Shift+H", action: "Exit Feed or Power Through (go to Imbox)" },
    { keys: "Shift+J / Shift+K", action: "Jump to next / previous email in Feed or Power Through" },
    { keys: "j / k", action: "Scroll in Feed or Power Through" },
    { keys: "1–6 / 9", action: "Workflow views" },
    { keys: "Screener i/f/p/x", action: "Imbox / Feed / Paper Trail / Block" },
    ...
    { keys: "g then i / s / u / t", action: "Imbox, starred, unread, sent" },
    { keys: "g then m", action: "Folders, labels, and empty piles" },
